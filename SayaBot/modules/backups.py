...
import SayaBot.modules.sql.notes_sql as sql
from SayaBot import dispatcher, LOGGER, OWNER_ID, JOIN_LOGGER, SUPPORT_CHAT
from SayaBot.__main__ import DATA_IMPORT
from SayaBot.modules.helper_funcs.chat_status import user_admin
from SayaBot.modules.helper_funcs.alternate import typing_action

# from SayaBot.modules.rules import get_rules
import SayaBot.modules.sql.rules_sql as rulessql

# from SayaBot.modules.sql import warns_sql as warnssql
import SayaBot.modules.sql.blacklist_sql as blacklistsql
from SayaBot.modules.sql import disable_sql as disabledsql

# from SayaBot.modules.sql import cust_filters_sql as filtersql
...
def export_data(update, context):
    ...
    with open("SayaBot{}.backup".format(chat_id), "w") as f:
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SayaBot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `SayaBot-Backup` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SayaBot{}.backup".format(chat_id))  # Cleaning file
