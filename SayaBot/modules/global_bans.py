...
import SayaBot.modules.sql.global_bans_sql as sql
from SayaBot.modules.sql.users_sql import get_user_com_chats
from SayaBot import (
    DEV_USERS,
    EVENT_LOGS,
    OWNER_ID,
...
from SayaBot.modules.helper_funcs.misc import send_to_list
