...
import SayaBot.modules.sql.feds_sql as sql
from SayaBot import (
    EVENT_LOGS,
    LOGGER,
    SUPPORT_CHAT,
...
from SayaBot.modules.helper_funcs.string_handling import markdown_parser
...
def fed_ban(update: Update, context: CallbackContext):
    ...
    if user_id == OWNER_ID:
        message.reply_text("I won't fed ban my bot creator, nice try though!")
        return
