...
import SayaBot.modules.sql.global_bans_sql as gban_sql
import SayaBot.modules.sql.users_sql as user_sql
from SayaBot import DEV_USERS, OWNER_ID, dispatcher
