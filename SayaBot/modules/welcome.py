...
import SayaBot.modules.sql.welcome_sql as sql
import SayaBot
from SayaBot import (
    DEV_USERS,
    LOGGER,
...
from SayaBot.modules.helper_funcs.misc import build_keyboard, revert_buttons
from SayaBot.modules.helper_funcs.msg_types import get_welcome_type
from SayaBot.modules.helper_funcs.string_handling import (
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Nice! Bot Owner is here now ^-^", reply_to_message_id=reply
                )
                welcome_log = (
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_text(
                    "Be cool! A member of the Mercury Solar Union just joined.",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_text(
                    "Whoa! A Venus Solar Union member just joined! Stay Alert!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_text(
                    "Huh! Someone with in Earth Solar Union just joined!",
                    reply_to_message_id=reply,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_text(
                    "Don't panic! A Mars Solar Union member just joined!", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_text(
                    "Oof! A Jupiter Solar Union member just joined!", reply_to_message_id=reply
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
                    f"#USER_JOINED\n"
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "H-Hey, where are you going..? ˃ᆺ˂", reply_to_message_id=reply
                )
                return
